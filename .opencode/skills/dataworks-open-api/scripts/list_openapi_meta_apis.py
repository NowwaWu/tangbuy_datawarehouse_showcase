#!/usr/bin/env python3
"""Fetch OpenAPI metadata API list for DataWorks and save to output/.
Env:
...
def fetch_json(url: str, timeout: int) -> dict:
    """Fetch JSON from URL. Tries urllib first, falls back to curl on SSL errors."""
    import ssl
    import subprocess
    
    headers = {"User-Agent": "codex-skill"}
...
def main() -> None:
    ...
    url = (
        f"https://next.api.aliyun.com/meta/v1/products/{args.product_code}"
